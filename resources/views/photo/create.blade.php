...
@section('content')
    <div class="add-photo-container py-4">
        <h3 class="form-title fw-bold mb-2 pb-2 border-bottom">Tambah Foto</h3>

        <!-- Tombol Kembali dengan ikon -->
        <a href="{{ route('photo.index') }}" class="btn btn-sm btn-secondary mb-2">
            ...
            <form action="{{ route('photo.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="custom-file-upload">
                        <input type="file" name="photo" id="photo" class="form-control @error('photo') is-invalid @enderror" accept="image/*" onchange="updateFileName(this)" style="display: none;">
                ...
                <a href="{{ route('photo.index') }}" class="btn btn-secondary mb-3">Batal</a>
            </form>
        </div>
    </div>
@endsection
